...
public class ChildTCM {
    public int chmedmreId,chmedmreMonths,chmedmreDoc,chmedmreState,cishu,
    userId,userSex,recordBookbuilding,recordCategory,chmedmrenum,
    ...
    public String chmedmreName,chmedmrerecordId,chmedmreChmed,chmedmreDe,
            recordInputtingcard,recordName,recordPostalcode,recordPlaceadress
    ...
    public Date chmedmreFollowdate,chmedmreNextfollow,
            userBirthday,recordData
    ;

    public int getChmedmreId() {
        return chmedmreId;
    }

    public void setChmedmreId(int chmedmreId) {
        this.chmedmreId = chmedmreId;
    }

    public int getChmedmreMonths() {
        return chmedmreMonths;
    }

    public void setChmedmreMonths(int chmedmreMonths) {
        this.chmedmreMonths = chmedmreMonths;
    }

    public int getChmedmreDoc() {
        return chmedmreDoc;
    }

    public void setChmedmreDoc(int chmedmreDoc) {
        this.chmedmreDoc = chmedmreDoc;
    }

    public int getChmedmreState() {
        return chmedmreState;
    }

    public void setChmedmreState(int chmedmreState) {
        this.chmedmreState = chmedmreState;
    }
    ...
    public int getChmedmrenum() {
        return chmedmrenum;
    }

    public void setChmedmrenum(int chmedmrenum) {
        this.chmedmrenum = chmedmrenum;
    }
    ...
    public String getChmedmreName() {
        return chmedmreName;
    }

    public void setChmedmreName(String chmedmreName) {
        this.chmedmreName = chmedmreName;
    }

    public String getChmedmrerecordId() {
        return chmedmrerecordId;
    }

    public void setChmedmrerecordId(String chmedmrerecordId) {
        this.chmedmrerecordId = chmedmrerecordId;
    }

    public String getChmedmreChmed() {
        return chmedmreChmed;
    }

    public void setChmedmreChmed(String chmedmreChmed) {
        this.chmedmreChmed = chmedmreChmed;
    }

    public String getChmedmreDe() {
        return chmedmreDe;
    }

    public void setChmedmreDe(String chmedmreDe) {
        this.chmedmreDe = chmedmreDe;
    }
    ...
    public Date getChmedmreFollowdate() {
        return chmedmreFollowdate;
    }

    public void setChmedmreFollowdate(Date chmedmreFollowdate) {
        this.chmedmreFollowdate = chmedmreFollowdate;
    }

    public Date getChmedmreNextfollow() {
        return chmedmreNextfollow;
    }

    public void setChmedmreNextfollow(Date chmedmreNextfollow) {
        this.chmedmreNextfollow = chmedmreNextfollow;
    }
    ...
    public String toString() {
        return "ChildTCM{" +
                "chmedmreId=" + chmedmreId +
                ", chmedmreMonths=" + chmedmreMonths +
                ", chmedmreDoc=" + chmedmreDoc +
                ", chmedmreState=" + chmedmreState +
                ", cishu=" + cishu +
                ", userId=" + userId +
                ", userSex=" + userSex +
                ", recordBookbuilding=" + recordBookbuilding +
                ", recordCategory=" + recordCategory +
                ", chmedmrenum=" + chmedmrenum +
                ...
                ", chmedmreName='" + chmedmreName + '\'' +
                ", chmedmrerecordId='" + chmedmrerecordId + '\'' +
                ", chmedmreChmed='" + chmedmreChmed + '\'' +
                ", chmedmreDe='" + chmedmreDe + '\'' +
                ...
                ", userDe='" + userDe + '\'' +
                ", chmedmreFollowdate=" + chmedmreFollowdate +
                ", chmedmreNextfollow=" + chmedmreNextfollow +
