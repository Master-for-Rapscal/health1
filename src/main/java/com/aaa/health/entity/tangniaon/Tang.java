...
public class Tang implements Serializable{
        private Integer hypertenId,recordId,hypertenVisitway,hypertenBloodheight,
                hypertenBloodlow,hypertenHrrest,hypertenSmokfir,hypertenDrinkfir,
                hypertenSportsfir,hypertenSportsthird,hypertenTakensaltfir,
                hypertenMentality,hypertenCom,hypertenTanghua,hypertenCompliance,
                hypertenUneffect,hypertenDixue,hypertenClassify,hypertenDoctor,hypertenState;
