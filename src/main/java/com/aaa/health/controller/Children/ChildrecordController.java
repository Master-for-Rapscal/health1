...
public class ChildrecordController {
    ...
    public String list(Model model) {
        ...
        model.addAttribute("roleList", childinsercordService.findList(queryMap));
        return "ChildrenInfo/Childrecord";
    }
    ...
    public Map<String, Object> getList(Page page ) {
        ...
        ret.put("rows", childinsercordService.findList(queryMap));
