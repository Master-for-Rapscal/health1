...
function checkItem(e){
    ...
    if ($("#"+e.className).prop("checked")==true) {
        $("input[class='"+e.className+"']").prop("checked",false);
        $("input[class='"+e.className+"']").prop("disabled",true);
        $("#"+e.className).prop("checked",true);
        $("#"+e.className).prop("disabled",false);
    }else{
        $("input[class='"+e.className+"']").prop("disabled",false);
    }
    var allCheckBox=[];
    allCheckBox =$("input[class='"+e.className+"']");
    var data = "";
    ...
    $("#"+e.className+"id").textbox('setValue',data);
}
(function($){
...
$.fn.radiobutton.defaults={width:15,height:15,value:null,disabled:false,checked:false,label:null,labelWidth:"auto",labelPosition:"after",labelAlign:"left",onChange:function(_50f){
}};
})(jQuery);
(function($){
var _510=1;
...
$.fn.checkbox.defaults={width:18,height:18,value:null,disabled:false,checked:false,label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"left",onChange:function(_531){
}};
})(jQuery);
(function($){
function init(_532){
