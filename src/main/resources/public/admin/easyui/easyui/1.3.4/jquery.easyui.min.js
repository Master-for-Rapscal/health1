...
//     var date=new Date();
//
//     $("input[class='easyui-datebox']").datebox('setValue',date.getFullYear()+'-'+(date.getMonth()+1)+'-'+date.getDate());
// })
$(function(){
    // $("input[class='easyui-datebox']").datebox('setValue', formatterDate(new Date()));
    var allinput=[];
    allinput =$("input[type='radio']");
    ...
    allinput =$("input[type='checkbox']");
    $(allinput).each(function () {
        if($(this).val()==1){
            var e =$(this).prop("name");
            $("input[name='"+e+"']").prop("checked",false);
            $("input[name='"+e+"']").prop("disabled",true);
            $(this).prop("checked",true);
...
function checkItem1(e){

    if ($(e).prop("checked")==true) {
        $("input[name='"+e.name+"']").prop("checked",false);
        $("input[name='"+e.name+"']").prop("disabled",true);
        var allCheckBox=[];
        allCheckBox =$("input[name='"+e.name+"']");
        var data = "";
        ...
        $("input[name='"+e.name+"']").prop("disabled",false);
    }
}
